...
extern int      d_pix_min, d_pix_max, d_pix_scale;
...
extern int      sintable[32768];
extern int      intsintable[32768];
extern int		blanktable[32768];		// PGM
...
void    Draw_StretchChar (int x, int y, int scale, int c);
